        ...
        <nav className="w-full h-16 border-b border-gray-200">
            <div className="hidden lg:flex items-center px-24 h-full">
                ...
                <div className="ml-auto">
                    <button onClick={()=> router.push('/coomingsoon')} className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md">Crea una cuenta GRATIS</button>
                </div>
                <div className="pl-4">
                    <button  onClick={()=> router.push('/coomingsoon')}className="px-4 py-2 rounded-md hover:bg-gray-200 border border-blue-600 text-blue-600">Iniciar sesión</button>
                </div>
                {/* <div className="pl-4">
