...
const Footer = () => {
    return (
        ...
        <footer className="max-w-screen-2xl px-4 md:px-8 lg:px-24 mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center border-t border-b gap-4 py-6">
            ...
            <div className="flex gap-4">
              <a href="https://www.linkedin.com/company/inmobu-llc/" target="_blank" className="text-gray-400 hover:text-gray-500 active:text-gray-600 transition duration-100">
          ...
          <div className="text-gray-400 text-sm text-center py-8">© 2021 - Inmobu LLC. Todos los derechos reservados.</div>
        </footer>
      </div>
    )
}
